...
subroutine Broad3
  ...
  If(NCent==3) Then
    ...
    !   call MPI_Bcast(frbc3(1,1,1,1),3*natom*nnhc*ncolor,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
    ...
    !   call MPI_Bcast(vrbc3(1,1,1,1),3*natom*nnhc*ncolor,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
    ...
    !   call MPI_Bcast(rbc3(1,1,1,1),3*natom*nnhc*ncolor,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
    !EndIf
  EndIf
