subroutine random_generator(num,rndnumber)
  use global_variable, only: iseed
  implicit none
  integer, parameter :: N = 1
  integer, intent(in)  :: num
  real(8), intent(out) :: rndnumber(N)
  !integer :: iseed(4)
  !real(8) :: rnd(N)
  !iseed(:) = [ 1, 3, 5, 7]
  call dlarnv(1, iseed, N, rndnumber)
  !print *, rnd

contains


  !subroutine RandomG(num, rndnumber)
  !  implicit none
  !  integer :: num ! = 1
  !  real(8) :: rndnumber(:)
  ...
  !
  !  call dlarnv(num, iseed(:), 1, rndnumber)
